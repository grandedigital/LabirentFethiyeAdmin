...
export default function FormCategorySeoUpdate({ closeModal, setIsAdded, selectedItem }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting }) => {
            try {
                ...
                await UpdateCategory(fd).then((res) => {
                    if (res?.statusCode === 200) {
                        openSnackbar({
                            open: true,
                            message: 'Seo Kategori düzenlendi.',
                            variant: 'alert',
            ...
            <FormikProvider value={formik}>
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                        <DialogTitle>Seo Kategori Düzenle</DialogTitle>
                        <Divider />
