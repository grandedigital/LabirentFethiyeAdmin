...
export default function VillaSelectModal({ id, title, open, handleClose, navigate, villaDetailModal }) {

  const navigateHandler = async () => {
    navigate(`/facilities/villas-update/${id}`)
    handleClose();
  };
